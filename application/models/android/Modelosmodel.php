...
class Modelosmodel extends CI_Model {
    ...
    function get_servicios_where($tipo) {
        $this->db->order_by("id");
        $arr = $this->db->query("select distinct marca, tipo,marca,clase from correlacion_android where tipo='".$tipo."'");
   ...
   function get_campos() {
    ...
    function get_tipos_de_clase($modelo,$tipo) {
        $arr = $this->db->query("select * from correlacion_android where tipo='".$tipo."' and marca='".$modelo."' order by modelo asc");
        //echo "select * from correlacion_android where tipo='".$tipo."' and marca='".$modelo."'";
        //print_r($arr);
        $r = $arr->result_array();
        //print_r($r);
        return ($r); 
      ...
      $a = $this->db->get("correlacion_android");
      $r = $a->result_array();
      //print_r($r);
