<script language="javascript">
  ...
  <div align="center">
    <?php
      ...
      $actual_link = str_replace("catalogo", "", $actual_link);
  ...
  foreach ($result as $item) {
    ...
    if($item['tabla']=="bitacora"){
      ...
      //echo $tipos[0]['num_orden'];
      if(empty($tipos[0]['num_orden'])){
        echo "<td><a target='_blank' href='https://".$item['sucursal_id'].".idoctor.mx/index.php/equipos/detalle/ver/".$orden."'>N/A</a></td>";
