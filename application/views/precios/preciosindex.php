...
<!--<div class="row">
    <div class="three columns">Descripción:</div>
    <div class="six columns"><?php echo form_input("busca_descripcion",(isset($busca_descripcion) ? $busca_descripcion : "")); ?></div>
    <div class="three columns"><?php echo form_submit("submit","Filtrar","class='button button-primary'"); ?></div>
</div>-->
