<?php echo form_open('prospectos/index'); ?>

<h5 align="center"><b>Prospectos</b></h5>

<div class="row">
    <div class="three columns" style="text-align:right">Mes:</div>
...
<div class="row">
    <br>
    <center>
        <button type="submit" class="btn btn-primary" style="background-color:#047c79; color:#FFFFFF;">Obtener Prospectos</button>
    </center>
    <br>
</div>
<script>
