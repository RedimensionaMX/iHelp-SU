<?php echo form_open('egresos/index'); ?>

<h5 align="center"><b>Egresos</b></h5>
...
<div class="row">
    <br>
    <center>
        <button type="submit" class="btn btn-primary" style="background-color:#047c79; color:#FFFFFF;">Obtener egresos</button>
    </center>
    <br>
</div>
<script>
